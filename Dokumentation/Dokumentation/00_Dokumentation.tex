...
\usepackage[left= 2.5cm,right = 2cm, top = 3 cm, bottom = 3 cm]{geometry}
...
\usepackage[
	...
	pdfsubject={Umsetzung eines Honeypots},
	pdfauthor={Michael Stroh, Daniel Schwenk},
	pdfkeywords={systemadministration,honeypot,security,weingarten},	
...
\include{03_anforderungsanalyse}

\include{04_marktanalyse}

\include{05_loesungsansaetze}
